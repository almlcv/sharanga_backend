...
class StockTransaction(BaseModel):
    ...
    transaction_type: str  # "PRODUCTION", "DISPATCH", "INSPECTION", "ROLLOVER_CORRECTION"
    quantity_change: int
...
class FGStockDocument(Document):
    ...
    - Complete audit trail with transactions
    - Smart rollover logic for opening stock
